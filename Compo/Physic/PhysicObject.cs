...
namespace CompoEngine.Physic
{
    internal class PhysicObject
    {
        ...
        public PhysicObject(Texture image, BodyDesc body)
        {
        ...
        public PhysicObject(Texture image, BodyDesc body, Vector2f size, Vector2f offset)
        {
            var images = new Texture[1];
            images[0] = image;
        ...
        public PhysicObject(string[] image, BodyDesc body)
        {
